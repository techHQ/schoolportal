...
?>
<h2 class="page-header">Departments<a href="index.php?r=department/edit&id=<?php echo $department->depart_id; ?>" class="btn btn-default pull-right">Update</a>

	<a href="index.php?r=department/create&id=<?php echo $department->depart_id; ?>" class="btn btn-primary pull-right">Create</a></h2>
